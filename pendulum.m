...
%-------------------------------------------------------------------------%
fprintf(['This code is a MATLAB animation that simulates the movement of a double pendulum. \n', ...
'Imagine two weights hanging from two ropes, one rope tied to the other in sequence. \n', ...
'When you release the weights, they start to move forward and backward. \n', ...
